...
try {
    ...
    print('Exception when calling AdminApi->applyIdentifyResult: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AdminApi->createBackup: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AdminApi->discardIdentifyTask: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AdminApi->getIdentifyTask: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AdminApi->listIdentifyTasks: $e\n');
}
```
...
try {
    ...
    print('Exception when calling AdminApi->runIdentifyTask: $e\n');
}
```
