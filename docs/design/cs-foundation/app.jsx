...
const ModePair = ({ children, label }) => (
  <div className="fs-pair">
    ...
    <div className="fs-pair-cell" data-mode="light">
      ...
      <div className="fs-pair-inner">
        {typeof children === 'function' ? children('light') : children}
      </div>
    </div>
  </div>
);
...
const ColorSection = () => {
  ...
  return (
    <Section
      ...
      n={1}
      title="Color"
      sub="A near-black surface stack with warm-paper light counterpart. Single confident accent: amber. Teal & indigo support secondary affordances. Each semantic color paired with shape/icon — never color alone."
    >
      ...
      <ModePair>
        {() => (
          <div style={{ padding: 16 }}>
            <div className="t-mute t-caption" style={{ marginBottom: 8 }}>
              Contrast samples
            </div>
...
const TypeSection = () => {
  const scale = [
    ...
    [
      'body',
      'A two-phase commit protocol coordinates atomic transactions across multiple participants.',
      '14 / 20 · 400',
    ],
  ...
  return (
    <Section
      ...
      n={2}
      title="Typography"
      sub="IBM Plex Sans for the UI; IBM Plex Mono for numerals, timestamps, paths. Tabular nums in any progress or table context."
    >
      <div className="fs-card">
        {scale.map(([cls, sample, meta]) => (
          <div key={cls} className="type-row">
            <div className="t-mono t-caption" style={{ minWidth: 120 }}>
              {cls}
            </div>
            <div className={`t-${cls}`} style={{ flex: 1 }}>
              {sample}
            </div>
            <div className="t-mono t-caption t-mute" style={{ minWidth: 110, textAlign: 'right' }}>
              {meta}
            </div>
          </div>
        ))}
      ...
      <div className="fs-grid" style={{ marginTop: 16 }}>
        <div className="fs-card">
          ...
          <p style={{ margin: 0, maxWidth: 60 + 'ch', textWrap: 'pretty' }}>
            CourseShelf is a self-hosted course management platform — for people who own video
            courses and actually want to finish them. Open it, see what's next, press resume. The
            interface stays out of your way.
          </p>
        </div>
        <div className="fs-card">
          <div className="t-caption" style={{ marginBottom: 8 }}>
          ...
          <table className="fs-num-table">
            <tbody>
              <tr>
                <td>Distributed Systems</td>
                <td className="t-mono">14:20:00</td>
                <td className="t-mono"> 43%</td>
              </tr>
              <tr>
                <td>PostgreSQL Performance</td>
                <td className="t-mono">11:45:00</td>
                <td className="t-mono"> 11%</td>
              </tr>
              <tr>
                <td>Compilers</td>
                <td className="t-mono">22:10:00</td>
                <td className="t-mono"> 0%</td>
              </tr>
              <tr>
                <td>Linear Algebra for ML</td>
                <td className="t-mono"> 8:30:00</td>
                <td className="t-mono"> 50%</td>
              </tr>
            </tbody>
          </table>
        </div>
...
const SpaceSection = () => {
  ...
  return (
    <Section
      ...
      n={3}
      title="Spacing"
      sub="4px base scale. Use 1–4 for component internals; 5–7 for component-to-component; 8–9 for section-to-section."
    >
      <div className="fs-card">
        {steps.map(([n, px]) => (
          <div key={n} className="space-row">
            <div className="t-mono t-caption" style={{ width: 60 }}>
              space-{n}
            </div>
...
const RadiusSection = () => (
  <Section
    ...
    n={4}
    title="Radius"
    sub="Three radii: sm for inline elements, md for cards & rows, lg for modals & large surfaces. Pill for chips & switches."
  >
    <div className="fs-grid-4">
      {[
        ['sm', 4, 'inputs · chips · skeletons'],
        ['md', 8, 'cards · buttons · rows'],
        ['lg', 16, 'modals · sheets · hero'],
        ['pill', 999, 'chips · switches · avatars'],
      ].map(([n, px, use]) => (
        <div key={n} className="fs-card" style={{ textAlign: 'center' }}>
          <div className="radius-demo" style={{ borderRadius: px === 999 ? 999 : px }} />
          <div className="t-body-strong" style={{ marginTop: 12 }}>
            radius-{n}
          </div>
          <div className="t-caption t-mono t-mute">{px === 999 ? '∞' : px + 'px'}</div>
          <div className="t-caption t-mute" style={{ marginTop: 4 }}>
            {use}
          </div>
        </div>
      ))}
...
const ButtonsSection = () => {
  ...
  return (
    <Section
      ...
      n={5}
      title="Buttons"
      sub="Primary, secondary, ghost, destructive — each in default, hover, active, focus, disabled, loading. Sentence case throughout."
    >
      <ModePair>
        {() => (
          <div style={{ padding: 16 }}>
              ...
              <tbody>
                {[
                  ...
                  <tr key={name}>
                    ...
                    <td>
                      <button className={`btn ${cls}`} data-force-hover>
                        {label}
                      </button>
                    </td>
                    <td>
                      <button className={`btn ${cls}`} data-force-active>
                        {label}
                      </button>
                    </td>
                    <td>
                      <button className={`btn ${cls}`} data-force-focus>
                        {label}
                      </button>
                    </td>
                    <td>
                    ...
                    <td>
                      <button className={`btn ${cls}`} data-loading="true">
                        {label}
                      </button>
                    </td>
                  </tr>
            ...
            <div className="t-caption" style={{ marginTop: 24, marginBottom: 8 }}>
              With icon · sizes · icon-only
            </div>
            ...
            <div className="t-caption" style={{ marginTop: 24, marginBottom: 8 }}>
              Click any primary to test loading transition
            </div>
            <button
...
const InputsSection = () => {
  ...
  return (
    <Section
      ...
      n={6}
      title="Inputs"
      sub="Text, search, number, select, switch, checkbox, radio — empty / filled / focus / error / disabled."
    >
      <ModePair>
        {() => (
          <div style={{ padding: 16 }}>
            ...
            <div className="t-caption" style={{ marginTop: 24, marginBottom: 12 }}>
...
const CardsSection = () => (
  <Section
    ...
    n={7}
    title="Cards"
    sub="Base card, dashboard tile, hover state. Three radii: rows md, dashboard md, modals lg."
  >
    <ModePair>
      {() => (
        <div style={{ padding: 16 }}>
          <div className="fs-grid-3">
            <div className="card">
              ...
              <p className="t-mute" style={{ margin: '4px 0 0', fontSize: 13 }}>
                Used for content blocks and panels.
              </p>
            </div>
            <div className="card card-hover">
              <div className="t-title">Card with hover</div>
              <p className="t-mute" style={{ margin: '4px 0 0', fontSize: 13 }}>
                Hover me — border darkens, surface lifts a step.
              </p>
            </div>
            <div className="card card-lg">
              <div className="t-title">Large card · radius-lg</div>
              <p className="t-mute" style={{ margin: '4px 0 0', fontSize: 13 }}>
                For hero or modal-like surfaces.
              </p>
            </div>
            ...
            <div className="card" style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              ...
              <div className="t-display t-mono">
                2.4<span className="t-heading t-mute"> TB</span>
              </div>
              <div className="progress-linear">
                <div className="progress-linear-fill" style={{ width: '62%' }} />
              </div>
            </div>
            <div className="card" style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              <div className="t-caption">LAST SCAN</div>
              <div className="t-title">Computer Science</div>
              <div className="t-caption t-mute">
                42 added · 3 updated ·{' '}
                <span className="dot success" style={{ verticalAlign: 'middle', marginRight: 4 }} />
                4 minutes ago
              </div>
            </div>
          </div>
...
const RowsSection = () => (
  <Section
    ...
    n={8}
    title="List rows"
    sub="Leading icon or avatar, title + sub, trailing meta. Selected and hover states. Compact density on mobile lists."
  >
    <ModePair>
      {() => (
            ...
            <div className="card" style={{ padding: 4 }}>
              <div className="row">
                ...
                <div className="row-body">
                  <div className="row-title">Vector spaces & bases</div>
                  <div className="row-sub">Lesson 1 · 12 min</div>
                </div>
                <div className="row-trailing">12:04</div>
              </div>
              <div className="row" aria-selected="true">
                ...
                <div className="row-body">
                  <div className="row-title">Linear maps & matrices</div>
                  <div className="row-sub">Lesson 2 · 18 min · current</div>
                </div>
                <div className="row-trailing">04:21 / 18:00</div>
              </div>
              <div className="row">
                <div className="row-leading">
                  <Icon name="circle" />
                ...
                <div className="row-body">
                  <div className="row-title">Eigenvalues & eigenvectors</div>
                  <div className="row-sub">Lesson 3 · 22 min</div>
                </div>
                <div className="row-trailing">22:00</div>
              </div>
              <div className="row">
                <div className="row-leading">
                  <Icon name="lock" />
                ...
                <div className="row-body">
                  <div className="row-title">Singular value decomposition</div>
                  <div className="row-sub t-mute">Lesson 4 · admin-only</div>
                </div>
                <div className="row-trailing">25:00</div>
              </div>
            </div>
          </div>
          <div style={{ flex: 1 }}>
            ...
            <div className="card" style={{ padding: 4 }}>
              <div className="row">
                <div className="row-leading">
                  <div className="avatar">
                    MK<span className="avatar-role avatar-role-admin">A</span>
                  </div>
                </div>
                <div className="row-body">
                  <div className="row-title">Mira Khoury</div>
                  <div className="row-sub">Admin · last active 2 minutes ago</div>
                </div>
              ...
              <div className="row">
                ...
                <div className="row-body">
                  <div className="row-title">Elena Lin</div>
                  <div className="row-sub">User · last active 1 hour ago</div>
                </div>
                <div className="row-trailing">
                  <Icon name="more" />
                </div>
              ...
              <div className="row">
                <div className="row-leading">
                  <div className="avatar">
                    JD<span className="avatar-role avatar-role-guest">G</span>
                  </div>
                </div>
                <div className="row-body">
                  <div className="row-title">Jordan Diaz</div>
                  <div className="row-sub">Guest · 3 grants</div>
                </div>
                <div className="row-trailing">
                  <Icon name="more" />
                </div>
...
const TabsSection = () => {
  ...
  return (
    <Section
      ...
      sub="Tabs for primary navigation within a screen; segmented for view-mode toggles."
    >
      <ModePair>
        {() => (
          <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <div className="seg">
              {[
                ...
                <button key={k} aria-selected={seg === k} onClick={() => setSeg(k)}>
                  {l}
                </button>
              ))}
            </div>
...
const FeedbackSection = () => {
  ...
  return (
    <Section
      ...
      n={10}
      title="Feedback"
      sub="Banners (info/success/warning/error), toasts, inline alerts. Sync indicators are inline, never modal."
    >
      <ModePair>
        {() => (
          <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 12 }}>
            <div className="banner banner-info">
              ...
              <div className="banner-body">
                <div className="banner-title">Self-registration is disabled</div>New users must be
                invited by an admin.
              </div>
            </div>
            <div className="banner banner-success">
              ...
              <div className="banner-body">
                <div className="banner-title">Library scan complete</div>42 courses added · 3
                updated · 0 errors.
              </div>
            </div>
            <div className="banner banner-warning">
              ...
              <div className="banner-body">
                <div className="banner-title">Storage 88% full</div>Free up space or downloads will
                fail.
              </div>
            </div>
            <div className="banner banner-error">
              <Icon name="alert" size={20} />
              <div className="banner-body">
                <div className="banner-title">Couldn't reach the server</div>Retrying in 5 seconds.{' '}
            ...
            <div className="fs-row" style={{ marginTop: 8 }}>
              <button
                ...
                onClick={() => fireToast('success', 'Bookmark saved at 04:21')}
              >
                Fire success toast
              </button>
              <button
                className="btn btn-secondary btn-sm"
                onClick={() => fireToast('info', 'Synced to all devices')}
              >
                Fire info toast
              </button>
              <button
                className="btn btn-secondary btn-sm"
                onClick={() => fireToast('error', "Couldn't save note — retrying")}
              >
                Fire error toast
              </button>
            </div>
            <div style={{ display: 'flex', flexDirection: 'column', gap: 8 }}>
              <div className="t-caption">
                Inline sync indicator (the "self-evident sync" pattern)
              </div>
...
const OverlaysSection = () => {
  ...
  return (
    <Section
      ...
      n={11}
      title="Overlays"
      sub="Dialogs (sm/md), bottom sheet on mobile, command palette on desktop. Used sparingly — prefer inline."
    >
      <ModePair>
        {(mode) => (
          <div style={{ padding: 16 }}>
            <div className="fs-row">
              <button
                ...
                onClick={() => setOpen(open === 'dialog' ? null : 'dialog')}
              >
                Open dialog
              </button>
              <button
                className="btn btn-secondary"
                onClick={() => setOpen(open === 'sheet' ? null : 'sheet')}
              >
                Open bottom sheet
              </button>
              <button
            ...
            <div className="overlay-stage" data-mode={mode}>
              ...
              {open === 'dialog' && (
                <div className="overlay-dialog card-lg" style={{ boxShadow: 'var(--shadow-3)' }}>
                  ...
                  <p className="t-mute" style={{ margin: '8px 0 16px', fontSize: 13 }}>
                    This sets every lesson in{' '}
                    <b style={{ color: 'var(--text)' }}>Distributed Systems Foundations</b> back to
                    not-started. Notes and bookmarks are kept.
                  </p>
                  <div className="fs-row" style={{ justifyContent: 'flex-end' }}>
                    <button className="btn btn-ghost" onClick={() => setOpen(null)}>
                      Cancel
                    </button>
                    <button className="btn btn-destructive" onClick={() => setOpen(null)}>
                      Reset progress
                    </button>
                  </div>
                </div>
              ...
              {open === 'sheet' && (
                <div className="overlay-sheet">
                  ...
                  <div className="t-caption" style={{ margin: '16px 0 8px' }}>
                    LIBRARY
                  </div>
                  <div className="fs-row" style={{ gap: 6, flexWrap: 'wrap' }}>
                  ...
                  >
                    ...
                    <button className="btn btn-primary btn-sm" onClick={() => setOpen(null)}>
                      Apply · 1 active
                    </button>
                  </div>
                </div>
              ...
              {open === 'palette' && (
                <div className="overlay-palette">
                  ...
                  >
                    ...
                    <input
                      className="input"
                      style={{ border: 'none', background: 'transparent', paddingLeft: 32 }}
                  ...
                  <div className="row">
                    ...
                    <div className="row-body">
                      <div className="row-title">Distributed Systems Foundations</div>
                    </div>
                  ...
                  <div className="row">
                    ...
                    <div className="row-body">
                      <div className="row-title">Modern PostgreSQL</div>
                    </div>
                    <div className="row-trailing"></div>
                  </div>
                  ...
                  <div className="row">
                    ...
                    <div className="row-body">
                      <div className="row-title">Switch theme</div>
                    </div>
                    <div className="row-trailing t-mono">⌘T</div>
                  </div>
                </div>
              )}
            </div>
...
const ProgressSection = () => (
  <Section
    ...
    n={12}
    title="Progress"
    sub="Linear, circular, ringed avatar, scrubber. Always pair percentage with bar — color alone never carries the meaning."
  >
    <ModePair>
      {() => (
        <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 24 }}>
          <div>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 10, maxWidth: 400 }}>
              <div className="progress-linear">
                <div className="progress-linear-fill" style={{ width: '0%' }} />
              </div>
              <div className="progress-linear">
                <div className="progress-linear-fill" style={{ width: '17%' }} />
              </div>
              <div className="progress-linear">
                <div className="progress-linear-fill" style={{ width: '62%' }} />
              </div>
            ...
            <div className="fs-row" style={{ gap: 24, alignItems: 'center' }}>
              {[0, 25, 50, 75, 100].map((p) => (
                <div key={p} style={{ textAlign: 'center' }}>
                  <Circular pct={p} />
                  <div className="t-caption t-mono t-mute" style={{ marginTop: 4 }}>
                    {p}%
                  </div>
                </div>
              ))}
          ...
          <div>
            <div className="t-caption" style={{ marginBottom: 12 }}>
              Ringed avatar (course cover with progress)
            </div>
              ...
              {[18, 47, 100].map((p) => (
                <div key={p} className="ring-cover" style={{ '--p': `${p}` }}>
                  <div className="ring-cover-inner" style={{ background: '#3F8C84' }}>
                    <span className="t-mono" style={{ fontSize: 11, color: '#fff' }}>
                      {p}%
                    </span>
                  </div>
                </div>
          ...
          <div>
            <div className="t-caption" style={{ marginBottom: 12 }}>
              Scrubber with chapter & bookmark markers
            </div>
            <Scrubber />
          </div>
        </div>
...
const Scrubber = () => {
  ...
  return (
    <div className="scrubber" ref={ref} onClick={onClick}>
      ...
      {[0.18, 0.42, 0.71].map((t) => (
        <div key={t} className="scrubber-chapter" style={{ left: `${t * 100}%` }} />
      ))}
      <div className="scrubber-bookmark" style={{ left: '58%' }}>
        <Icon name="bookmark" size={12} fill />
      </div>
    </div>
  );
};
...
const EmptySection = () => (
  <Section
    ...
    n={13}
    title="Empty states"
    sub="Name the gap, propose an action. Always offer a way forward — never a dead end."
  >
    <ModePair>
      {() => (
        <div style={{ padding: 16 }}>
          <div className="fs-grid">
            <div className="card empty">
              ...
              <p className="t-mute" style={{ margin: '4px 0 12px', fontSize: 13 }}>
                Add a library and CourseShelf will scan it.
              </p>
            ...
            <div className="card empty">
              ...
              <p className="t-mute" style={{ margin: '4px 0 12px', fontSize: 13 }}>
                Try a broader term, or remove the duration filter.
              </p>
              <button className="btn btn-secondary btn-sm">Clear filters</button>
            </div>
            <div className="card empty">
              <div className="empty-glyph error-glyph">
                <Icon name="alert" size={32} />
              </div>
              <div className="t-title">Couldn't load lessons</div>
              <p className="t-mute" style={{ margin: '4px 0 12px', fontSize: 13 }}>
                The server returned an error. Your progress is safe.
              </p>
            ...
            <div className="card empty">
              ...
              <p className="t-mute" style={{ margin: '4px 0 12px', fontSize: 13 }}>
                Ask an admin to grant you access to this library.
              </p>
...
const SkeletonSection = () => (
  <Section
    ...
    sub="Subtle 1.4s pulse — never aggressive. Used for lists, cards, detail pages. Buttons spin instead."
  >
    <ModePair>
      {() => (
        <div style={{ padding: 16 }}>
          <div className="fs-grid">
            ...
            <div>
              ...
              <div className="card" style={{ padding: 16, display: 'flex', gap: 16 }}>
                <div
                  className="skel"
                  style={{ width: 120, height: 80, flexShrink: 0, borderRadius: 8 }}
                />
...
const AvatarSection = () => (
  <Section
    ...
    n={15}
    title="Avatar"
    sub="Sizes xs / sm / md / lg / xl. Role badge: ADMIN (amber) · GUEST (indigo). USER has no badge — it's the unmarked default."
  >
    <ModePair>
      {() => (
        <div style={{ padding: 16 }}>
...
const ChipsSection = () => {
  ...
  return (
    <Section
      ...
      n={16}
      title="Tag / chip"
      sub="Default, primary, semantic, removable. Used for filters, status, tags."
    >
      <ModePair>
        {() => (
          <div style={{ padding: 16, display: 'flex', flexDirection: 'column', gap: 16 }}>
              ...
              <div className="fs-row" style={{ flexWrap: 'wrap' }}>
                ...
                {chips.length === 0 && (
                  <span className="t-caption t-mute">
                    No filters · click chips above to add (demo)
                  </span>
                )}
              </div>
            </div>
    ...
    <div className="fs-root" data-screen-label="cs-foundations">
      <header className="fs-header">
        <div>
          ...
          <p className="t-mute" style={{ margin: '8px 0 0', maxWidth: '68ch' }}>
            The CourseShelf design system. Every primitive in every state, dark and light
            side-by-side. All values flow from <span className="t-mono">tokens.json</span>.
          </p>
        </div>
        <div className="fs-toolbar">
          <div className="seg">
            <button aria-selected={mode === 'dark'} onClick={() => setMode('dark')}>
              <Icon name="moon" size={14} /> Dark
            </button>
            <button aria-selected={mode === 'light'} onClick={() => setMode('light')}>
          ...
          <div className="seg">
            ...
            <button aria-selected={density === 'compact'} onClick={() => setDensity('compact')}>
              Compact
            </button>
          </div>
        </div>
      ...
      <nav className="fs-toc">
        {sections.map(([id, label], i) => (
          <a key={id} href={`#${id}`}>
            <span className="t-mono">{String(i + 1).padStart(2, '0')}</span> {label}
          </a>
        ))}
      </nav>
      ...
      <footer className="fs-footer t-caption t-mute">
        CourseShelf · cs-foundations · WCAG 2.1 AA · Reduce-motion respected · {sections.length}{' '}
        sections
      </footer>
    </div>
  );
