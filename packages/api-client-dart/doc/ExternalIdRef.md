...
**url** | **String** | Optional canonical URL of the entity on the source platform. Must be an absolute `http` or `https` URL, ASCII-only — percent-encode any non-ASCII characters. | [optional] 
