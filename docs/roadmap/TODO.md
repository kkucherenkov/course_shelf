...
Progress: `9 / 115` complete (update by hand or via a pre-commit hook).
...
- [ ] [E07-F01-S01](./tasks/E07-F01-S01.md) `A` — AccessGrant aggregate + admin endpoints · ⇐ E06-F01-S01
...
- [ ] [E13-F01-S07](./tasks/E13-F01-S07.md) `A` — AppBanner (info/success/warning/error), AppToast, inline alerts · ⇐ E12-F01-S01, E13-F01-S01
...
- [ ] [E21-F01-S01](./tasks/E21-F01-S01.md) `A` — GET /admin/dashboard aggregator · ⇐ E10-F01-S01, E07-F01-S01
- [ ] [E21-F01-S02](./tasks/E21-F01-S02.md) `A` — POST /admin/backups (DB snapshot archive) · ⇐ E04-F02-S03
- [ ] [E21-F02-S01](./tasks/E21-F02-S01.md) `A` — Rate limit on Better Auth sign-in · ⇐ E04-F02-S03
