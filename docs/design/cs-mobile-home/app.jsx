    ...
    <div data-screen-label="cs-mobile-home" style={{ padding: '24px' }}>
      <div style={{ maxWidth: 1200, margin: '0 auto' }}>
        ...
        <p className="t-mute" style={{ margin: 0, marginBottom: 24, maxWidth: '68ch' }}>
          Three reference screens. Tab bar at the bottom. Compact density on lists.
        </p>
        <div className="mobile-stage">
          <Phone activeTab="home" label="HOME">
            ...
            <div style={{ padding: '0 16px' }}>
              <div style={{ display: 'flex', alignItems: 'center', gap: 8, marginBottom: 8 }}>
                ...
                <div className="t-caption t-mute" style={{ flex: 1 }}>
                  Welcome back, Elena
                </div>
              </div>
            </div>
            <div className="mobile-section-h">
              ...
              <span className="t-caption t-mute">More</span>
            </div>
          ...
          <Phone activeTab="browse" label="BROWSE">
            ...
            <div style={{ padding: '0 16px 8px', display: 'flex', gap: 6, flexWrap: 'wrap' }}>
              <span className="chip chip-primary chip-removable">
                In progress
          ...
          <Phone activeTab="downloads" label="DOWNLOADS">
            ...
            <div style={{ padding: '0 16px 12px' }}>
              <div className="card" style={{ padding: 12 }}>
                ...
                <div className="progress-linear">
                  <div className="progress-linear-fill" style={{ width: '26%' }} />
                </div>
              </div>
            </div>
            <div className="mobile-section-h">
            ...
            <div>
              ...
              />
              <DownloadRow
                lesson="Single-leader replication"
                course="Distributed Systems"
                size="124 MB"
                state="ready"
                accent="teal"
            ...
            <div className="mobile-section-h">
              <h3 style={{ color: 'var(--error)' }}>Failed · 1</h3>
            </div>
            <div>
              <DownloadRow
                lesson="Eigenvectors deep dive"
                course="Linear Algebra for ML"
                size="142 MB"
                state="failed"
                accent="teal"
