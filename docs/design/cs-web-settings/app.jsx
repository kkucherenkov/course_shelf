        ...
        <div className="set-shell" data-bp={bp}>
          ...
          <div className="set-main">
            <header className="set-topbar">
              {bp === 'xs' && (
                <button className="btn btn-ghost btn-icon btn-sm" aria-label="Back">
  ...
  return (
    <div className="set-stage" data-screen-label="01 cs-web-settings">
      <div className="set-stage-h">
        ...
        >
          Single column, max 720px wide on desktop. Four sections: Profile · Appearance · Playback ·
          Account. Inline saves with the self-evident sync indicator (a small inline status next to
          each row label, plus a 2px accent on the row's left edge that flashes green on save).
        </p>
      </div>
      ...
      <section>
        <div className="set-cluster-h">
          State: saving · "Display name" mid-save · spinner + info accent
        </div>
      ...
      <section>
        <div className="set-cluster-h">
          State: saved · "Theme" just persisted · success check + green flash
        </div>
      ...
      <section>
        <div className="set-cluster-h">
          State: error · banner + per-row error on "Autoplay" toggle
        </div>
