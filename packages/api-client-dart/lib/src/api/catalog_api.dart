...
class CatalogApi {
  ...
  ///
  /// Parameters:
  /// * [id] - Server-generated cuid identifying the transcription run.
  ...
  Future<Response<TranscriptionDto>> cancelTranscription({ 
    required String id,
    ...
    final _path = r'/api/v1/transcriptions/{id}/cancel'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CourseDto>> getCourse({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/courses/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ScanDto>> getLatestLibraryScan({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/libraries/{id}/scans/latest'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [TranscriptionDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TranscriptionDto>> getLatestTranscription({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/libraries/{id}/transcriptions/latest'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LessonDto>> getLesson({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/lessons/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LibraryDto>> getLibrary({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [CourseListDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CourseListDto>> listCourses({ 
    ...
    CourseListDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(CourseListDto),
      ) as CourseListDto;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [LibraryListDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LibraryListDto>> listLibraries({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/libraries';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    LibraryListDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(LibraryListDto),
      ) as LibraryListDto;
    ...
    return Response<LibraryListDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TranscriptionListDto>> listLibraryTranscriptions({ 
    required String id,
    int? limit = 20,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/v1/libraries/{id}/transcriptions'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [LibraryDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LibraryDto>> registerLibrary({ 
    required RegisterLibraryRequest registerLibraryRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(RegisterLibraryRequest);
      _bodyData = _serializers.serialize(registerLibraryRequest, specifiedType: _type);
  ...
  /// Re-walks only this course&#39;s on-disk folder instead of the whole library — the walk itself stays whole (it is a cheap directory listing), but the expensive per-video work (ffprobe, thumbnails, sidecar ingest) and orphan cleanup are both scoped to this course. Orphan cleanup never considers another course&#39;s lessons or transcripts during a scoped rescan.  Naming one course is also the force signal: unlike a library-wide scan, which skips any course it has already imported, a rescan re-derives that course&#39;s sections, lesson order and lesson rows from what is on disk right now. Concretely it adds lessons the first import missed, renumbers every lesson to &#x60;1..n&#x60; within its section, and removes lessons whose video file is gone — together with their transcripts, cues, progress, bookmarks and notes. Lessons that are still on disk keep their id, so progress and bookmarks survive.  The course&#39;s own metadata is never re-derived: title, description, poster, level, language, rating, instructors, studios and tags stay exactly as they are, including edits made through the API. Only the structure below the course is rebuilt. A lesson is removed only when the folder itself was re-read successfully — if the folder has vanished from disk the rescan reports an error and changes nothing.  Returns 202 immediately with &#x60;status: running&#x60;, exactly like &#x60;POST /libraries/{id}/scans&#x60;; clients poll &#x60;GET /libraries/{id}/scans/latest&#x60;. The response and its realtime &#x60;scans:user:{userId}&#x60; events carry &#x60;scopeCourseId&#x60; / &#x60;scopeCourseName&#x60; so the UI can say \&quot;rescanning &lt;course&gt;\&quot; rather than implying a full library scan. 
  ///
  /// Parameters:
  ...
  ///
  /// Parameters:
  /// * [id] - Server-generated cuid identifying the library to scan.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future] containing a [Response] with a [ScanDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ScanDto>> runLibraryScan({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/libraries/{id}/scans'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [id] - Server-generated cuid identifying the library to transcribe.
  /// * [startTranscriptionRequest] 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  ...
  /// Returns a [Future] containing a [Response] with a [TranscriptionDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TranscriptionDto>> startTranscription({ 
    required String id,
    StartTranscriptionRequest? startTranscriptionRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
  ...
  /// Returns a [Future] containing a [Response] with a [CourseDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<CourseDto>> updateCourse({ 
    required String id,
    ...
    try {
      ...
      _bodyData = _serializers.serialize(updateCourseRequest, specifiedType: _type);
