...
/// * [coursesTotal] - Total number of courses linked to this tag.
/// * [createdAt] 
/// * [updatedAt] 
@BuiltValue()
abstract class TagDto implements Built<TagDto, TagDtoBuilder> {
  ...
  factory TagDto([void updates(TagDtoBuilder b)]) = _$TagDto;

  @BuiltValueHook(initializeBuilder: true)
  static void _defaults(TagDtoBuilder b) => b;

  @BuiltValueSerializer(custom: true)
  static Serializer<TagDto> get serializer => _$TagDtoSerializer();
}

class _$TagDtoSerializer implements PrimitiveSerializer<TagDto> {
  @override
  final Iterable<Type> types = const [TagDto, _$TagDto];

  @override
  final String wireName = r'TagDto';
