  ...
  <div className="auth-page" style={{minHeight: 720}}>
    <div className="auth-pane">
      ...
      <div className="auth-meta-foot">
        ...
        <span><a>Status</a> · <a>Docs</a> · <a>Self-host guide</a></span>
      </div>
    </div>
  ...
  return (
    <div className="auth-stage" data-screen-label="cs-web-auth">
      <div style={{marginBottom:24}}>
        ...
        <h1 className="t-display" style={{margin:'4px 0 0'}}>Auth flows · web</h1>
        <p className="t-mute" style={{margin:'8px 0 0', maxWidth:'68ch'}}>Split-screen — form on the left, calm marketing pane on the right that reinforces the self-hosted promise. Same shell across sign-in, sign-up steps, and recovery.</p>
      </div>
      <div className="auth-tabs">
        {[['sign-in','Sign in'],['sign-in-error','Sign in · error'],['sign-up-1','Sign up · 1 Account'],['sign-up-2','Sign up · 2 Verify'],['sign-up-3','Sign up · 3 Library'],['forgot-1','Forgot · request'],['forgot-2','Forgot · sent'],['forgot-3','Forgot · new password']].map(([k,l]) => (
      ...
      <Frame url={`courseshelf.local/${tab.replace(/-\d$/,'').replace('-error','')}`}>
        ...
        {tab === 'sign-in-error' && <Split variant="sign-in" form={<SignInForm error="That email and password don't match. Try again, or reset your password."/>}/>}
