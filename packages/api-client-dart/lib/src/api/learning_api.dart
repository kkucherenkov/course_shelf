...
class LearningApi {
  ...
  Future<Response<QuizDto>> applyQuiz({ 
    required String id,
    ...
    final _path = r'/api/v1/quizzes/{id}/apply'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BookmarkDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BookmarkDto>> createBookmark({ 
    ...
    final _path = r'/api/v1/lessons/{lessonId}/bookmarks'.replaceAll('{' r'lessonId' '}', encodeQueryParameter(_serializers, lessonId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(CreateBookmarkRequest);
      _bodyData = _serializers.serialize(createBookmarkRequest, specifiedType: _type);
    ...
    BookmarkDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BookmarkDto),
      ) as BookmarkDto;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [FlashcardDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FlashcardDto>> createFlashcard({ 
    required String lessonId,
    required CreateFlashcardRequest createFlashcardRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/lessons/{lessonId}/flashcards'.replaceAll('{' r'lessonId' '}', encodeQueryParameter(_serializers, lessonId, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(CreateFlashcardRequest);
      _bodyData = _serializers.serialize(createFlashcardRequest, specifiedType: _type);
    ...
    FlashcardDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(FlashcardDto),
      ) as FlashcardDto;
  ...
  ///
  /// Parameters:
  /// * [id] - Server-generated cuid identifying the bookmark to delete.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  ///
  /// Parameters:
  /// * [id] - Server-generated cuid identifying the flashcard to delete.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// Returns a [Future]
  /// Throws [DioException] if API call or serialization fails
  Future<Response<void>> deleteFlashcard({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/flashcards/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  Future<Response<void>> deleteNote({ 
    ...
    final _path = r'/api/v1/notes/{lessonId}'.replaceAll('{' r'lessonId' '}', encodeQueryParameter(_serializers, lessonId, const FullType(String)).toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Returns a [Future] containing a [Response] with a [QuizDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<QuizDto>> discardQuiz({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/quizzes/{id}/discard'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [id] - Server-generated cuid identifying the course to generate quizzes for.
  /// * [generateQuizRequest] 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [QuizGenerationAcceptedDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<QuizGenerationAcceptedDto>> generateCourseQuiz({ 
    required String id,
    ...
    final _path = r'/api/v1/courses/{id}/quizzes'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(GenerateQuizRequest);
      _bodyData = generateQuizRequest == null ? null : _serializers.serialize(generateQuizRequest, specifiedType: _type);
    ...
    QuizGenerationAcceptedDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(QuizGenerationAcceptedDto),
      ) as QuizGenerationAcceptedDto;
    ...
    return Response<QuizGenerationAcceptedDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  ///
  /// Parameters:
  /// * [id] - Server-generated cuid identifying the lesson to generate a quiz for.
  /// * [generateQuizRequest] 
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  ...
  /// Returns a [Future] containing a [Response] with a [QuizGenerationAcceptedDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<QuizGenerationAcceptedDto>> generateLessonQuiz({ 
    required String id,
    GenerateQuizRequest? generateQuizRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/v1/lessons/{id}/quizzes'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LessonProgressDto>> getLessonProgress({ 
    required String lessonId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/progress/{lessonId}'.replaceAll('{' r'lessonId' '}', encodeQueryParameter(_serializers, lessonId, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [NoteDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NoteDto>> getNote({ 
    required String lessonId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    NoteDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(NoteDto),
      ) as NoteDto;
  ...
  /// Returns a [Future] containing a [Response] with a [QuizDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<QuizDto>> getQuiz({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/quizzes/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [id] - Server-generated cuid identifying the flashcard to grade.
  ...
  /// Returns a [Future] containing a [Response] with a [FlashcardDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FlashcardDto>> gradeFlashcard({ 
    required String id,
    required GradeFlashcardRequest gradeFlashcardRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/flashcards/{id}/grade'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(GradeFlashcardRequest);
      _bodyData = _serializers.serialize(gradeFlashcardRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [FlashcardListDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FlashcardListDto>> listDueFlashcards({ 
    int? limit = 20,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/flashcards/due';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    FlashcardListDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(FlashcardListDto),
      ) as FlashcardListDto;
    ...
    return Response<FlashcardListDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BookmarkListDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BookmarkListDto>> listLessonBookmarks({ 
    required String lessonId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    BookmarkListDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BookmarkListDto),
      ) as BookmarkListDto;
    ...
    return Response<BookmarkListDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [FlashcardListDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FlashcardListDto>> listLessonFlashcards({ 
    required String lessonId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [QuizListDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<QuizListDto>> listQuizzes({ 
    QuizStatus? status,
    String? lessonId,
    String? courseId,
    CancelToken? cancelToken,
    ...
    final _queryParameters = <String, dynamic>{
      if (status != null) r'status': encodeQueryParameter(_serializers, status, const FullType(QuizStatus)),
      if (lessonId != null) r'lessonId': encodeQueryParameter(_serializers, lessonId, const FullType(String)),
      if (courseId != null) r'courseId': encodeQueryParameter(_serializers, courseId, const FullType(String)),
    };
    ...
    QuizListDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(QuizListDto),
      ) as QuizListDto;
  ...
  /// Returns a [Future] containing a [Response] with a [LessonProgressDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<LessonProgressDto>> recordLessonProgress({ 
    required RecordProgressRequest recordProgressRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(RecordProgressRequest);
      _bodyData = _serializers.serialize(recordProgressRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [BatchProgressResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BatchProgressResponse>> recordLessonProgressBatch({ 
    required BatchProgressRequest batchProgressRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/progress/batch';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(BatchProgressRequest);
      _bodyData = _serializers.serialize(batchProgressRequest, specifiedType: _type);
    ...
    BatchProgressResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(BatchProgressResponse),
  ...
  ///
  /// Parameters:
  /// * [id] - Server-generated cuid identifying the bookmark to update.
  ...
  /// Returns a [Future] containing a [Response] with a [BookmarkDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<BookmarkDto>> updateBookmark({ 
    required String id,
    required UpdateBookmarkRequest updateBookmarkRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateBookmarkRequest);
      _bodyData = _serializers.serialize(updateBookmarkRequest, specifiedType: _type);
  ...
  ///
  /// Parameters:
  /// * [id] - Server-generated cuid identifying the flashcard to update.
  ...
  /// Returns a [Future] containing a [Response] with a [FlashcardDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<FlashcardDto>> updateFlashcard({ 
    required String id,
    required UpdateFlashcardRequest updateFlashcardRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpdateFlashcardRequest);
      _bodyData = _serializers.serialize(updateFlashcardRequest, specifiedType: _type);
  ...
  /// Returns a [Future] containing a [Response] with a [NoteDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<NoteDto>> upsertNote({ 
    required UpsertNoteRequest upsertNoteRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpsertNoteRequest);
      _bodyData = _serializers.serialize(upsertNoteRequest, specifiedType: _type);
