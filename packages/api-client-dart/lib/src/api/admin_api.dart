...
class AdminApi {
  ...
  ///
  /// Returns a [Future] containing a [Response] with a [IdentifyTaskDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<IdentifyTaskDto>> applyIdentifyResult({ 
    required String id,
    ApplyIdentifyRequest? applyIdentifyRequest,
    ...
    final _path = r'/api/v1/admin/identify-tasks/{id}/apply'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    ...
    try {
      const _type = FullType(ApplyIdentifyRequest);
      _bodyData = applyIdentifyRequest == null ? null : _serializers.serialize(applyIdentifyRequest, specifiedType: _type);
    ...
    IdentifyTaskDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(IdentifyTaskDto),
      ) as IdentifyTaskDto;
    ...
    return Response<IdentifyTaskDto>(
      data: _responseData,
  ...
  /// Returns a [Future] containing a [Response] with a [IdentifyTaskDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<IdentifyTaskDto>> discardIdentifyTask({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/admin/identify-tasks/{id}/discard'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
  ...
  ///
  /// Parameters:
  /// * [id] - Backup id from the create response.
  /// * [token] - Signed backup token, valid for `BACKUP_TOKEN_TTL_SECONDS`.
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  Future<Response<Uint8List>> downloadBackup({ 
    ...
    final _path = r'/api/v1/admin/backups/{id}/download'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AdminDashboardDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminDashboardDto>> getAdminDashboard({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    AdminDashboardDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminDashboardDto),
    ...
    return Response<AdminDashboardDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [HasUsersResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<HasUsersResponse>> getAdminHasUsers({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/admin/has-users';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    HasUsersResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(HasUsersResponse),
      ) as HasUsersResponse;
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminUserListItem>> getAdminUser({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  /// Returns a [Future] containing a [Response] with a [IdentifyTaskDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<IdentifyTaskDto>> getIdentifyTask({ 
    required String id,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/admin/identify-tasks/{id}'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AdminLibraryListDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminLibraryListDto>> listAdminLibraries({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/admin/libraries';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    AdminLibraryListDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminLibraryListDto),
    ...
    return Response<AdminLibraryListDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [libraryId] - When set, only return scans for the given library. Used by the admin library-detail page's scan-history table. Unknown library ids return an empty list (not 404 — the view is a filter, not a fetch).
  /// * [cancelToken] - A [CancelToken] that can be used to cancel the operation
  /// * [headers] - Can be used to add additional headers to the request
  /// * [extras] - Can be used to add flags to the request
  /// * [validateStatus] - A [ValidateStatus] callback that can be used to determine request success based on the HTTP status of the response
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [AdminScanListDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<AdminScanListDto>> listAdminScans({ 
    int? limit = 20,
    String? libraryId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    ...
    final _path = r'/api/v1/admin/scans';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    AdminScanListDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(AdminScanListDto),
      ) as AdminScanListDto;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [IdentifyTaskListDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<IdentifyTaskListDto>> listIdentifyTasks({ 
    IdentifyTaskStatus? status,
    String? courseId,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ...
    final _path = r'/api/v1/admin/identify-tasks';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    final _queryParameters = <String, dynamic>{
      if (status != null) r'status': encodeQueryParameter(_serializers, status, const FullType(IdentifyTaskStatus)),
    ...
    IdentifyTaskListDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(IdentifyTaskListDto),
      ) as IdentifyTaskListDto;
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ScraperListDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ScraperListDto>> listScrapers({ 
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/admin/scrapers';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{
        ...?headers,
    ...
    ScraperListDto? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ScraperListDto),
      ) as ScraperListDto;
    ...
    return Response<ScraperListDto>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Returns a [Future] containing a [Response] with a [IdentifyTaskDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<IdentifyTaskDto>> runIdentifyTask({ 
    required String id,
    required RunIdentifyRequest runIdentifyRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/admin/courses/{id}/identify'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(RunIdentifyRequest);
      _bodyData = _serializers.serialize(runIdentifyRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [ScrapePreviewResponse] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<ScrapePreviewResponse>> scrapeCoursePreview({ 
    required String id,
    required ScrapePreviewRequest scrapePreviewRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/admin/courses/{id}/scrape-preview'.replaceAll('{' r'id' '}', encodeQueryParameter(_serializers, id, const FullType(String)).toString());
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(ScrapePreviewRequest);
      _bodyData = _serializers.serialize(scrapePreviewRequest, specifiedType: _type);
    ...
    ScrapePreviewResponse? _responseData;

    try {
      final rawResponse = _response.data;
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(ScrapePreviewResponse),
      ) as ScrapePreviewResponse;
    ...
    return Response<ScrapePreviewResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [InstructorDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<InstructorDto>> upsertInstructor({ 
    required UpsertInstructorRequest upsertInstructorRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/admin/instructors';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(UpsertInstructorRequest);
      _bodyData = _serializers.serialize(upsertInstructorRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [StudioDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<StudioDto>> upsertStudio({ 
    required UpsertStudioRequest upsertStudioRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    final _path = r'/api/v1/admin/studios';
    final _options = Options(
      method: r'POST',
      headers: <String, dynamic>{
        ...?headers,
    ...
    try {
      const _type = FullType(UpsertStudioRequest);
      _bodyData = _serializers.serialize(upsertStudioRequest, specifiedType: _type);
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [TagDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<TagDto>> upsertTag({ 
    required UpsertTagRequest upsertTagRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
    ValidateStatus? validateStatus,
    ...
    try {
      const _type = FullType(UpsertTagRequest);
      _bodyData = _serializers.serialize(upsertTagRequest, specifiedType: _type);
