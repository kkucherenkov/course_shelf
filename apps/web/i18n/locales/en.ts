  ...
  pages: {
    home: {
      ...
      yourWeek: {
        ...
        errorBody: 'Check your connection, then try again.',
        retry: 'Retry',
        dueCount: '{n} card due | {n} cards due',
    ...
    flashcards: {
      review: {
        title: 'Review',
        remaining: '{n} card left | {n} cards left',
        ...
        gradeGood: 'Good',
        gradeEasy: 'Easy',
        gradeError: 'Could not save your grade. Please try again.',
        shortcutsHint: 'Space to reveal · 1-4 to grade',
      },
    },
    signIn: {
      title: 'Sign in',
    ...
    courseDetail: {
      ...
      loadErrorTitle: 'Could not load this course',
      retry: 'Retry',
      noAccess: 'No access',
    ...
    lessonPlayer: {
      ...
      flashcard: {
        createFromNote: '+ Make a flashcard',
        createFromTranscript: 'Create a flashcard from this line',
        dialogTitle: 'New flashcard',
        dialogDismiss: 'Close',
        frontLabel: 'Front',
        backLabel: 'Back',
        ...
        error: 'Could not create the flashcard. Please try again.',
      },
      aria: {
    ...
    admin: {
      ...
      libraryDetail: {
        ...
        scanProgressPartial: 'Scan partial',
