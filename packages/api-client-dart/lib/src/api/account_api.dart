...
class AccountApi {
  ...
  Future<Response<void>> signOutOtherSessions({ 
    ...
    final _path = r'/api/v1/me/sign-out-others';
  ...
  /// * [onReceiveProgress] - A [ProgressCallback] that can be used to get the receive progress
  ///
  /// Returns a [Future] containing a [Response] with a [MeDto] as data
  /// Throws [DioException] if API call or serialization fails
  Future<Response<MeDto>> updateMe({ 
    ...
    try {
      ...
      _responseData = rawResponse == null ? null : _serializers.deserialize(
        rawResponse,
        specifiedType: const FullType(MeDto),
      ) as MeDto;
