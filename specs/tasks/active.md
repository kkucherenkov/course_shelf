...
- Codegen impact: no
- Sub-steps:
  - [ ] e2e guard: a long outline must scroll inside the sidebar, not the document
  - [ ] cap `.page-lesson-player__sidebar` in `dvh`, as the transcript panel already is
  - [ ] remeasure on the audit stack at 1440x900 and 390x844
- Status: in-progress
- Blockers: —
