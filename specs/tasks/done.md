...
- Status: done — 3 defects found along the way flagged to maintainer for consult, not fixed in this PR
- Blockers: —
- Completed: 2026-09-16
- Result: [PR #648](https://github.com/kkucherenkov/course_shelf/pull/648)
...
typecheck --force` — all green (`@app/web` 475/475, `@app/ui`
        922/922)
- PR: https://github.com/kkucherenkov/course_shelf/pull/613 (merged)
...
- Result: https://github.com/kkucherenkov/course_shelf/pull/442
...
- Result: https://github.com/kkucherenkov/course_shelf/pull/439
...
- Completed: 2026-08-31
- Result: https://github.com/kkucherenkov/course_shelf/pull/437
...
- Sub-steps:
  ...
  - [x] re-record Flutter goldens and web visual snapshots in CI (Actions →
        _Regenerate visual snapshots_, suite `both`) — 47 of 76 goldens, 68 of
        293 Storybook snapshots and 1 e2e baseline moved. Every one of the 116
        kept its pixel dimensions, so the diff is colour only, not layout.
